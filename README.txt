...
* En el documento se indica al final de los resultados, que con lo obtenido en los experimentos, se ha establecido el umbral por defecto en el 15%, en el caso de querer modificar este umbral, se deberá modificar en el archivo 'funcionesAuxiliares.py' las líneas 236 y 237. Estas líneas contienen las variables 'radio_arriba' y 'radio_abajo'. Con un umbral del 15% estás variables tienen asignados los valores '1.15' y '0.85', en el caso de querer probar por ejemplo el umbral 25%, deberá ajustar estos valores a '1.25' y '0.75' respectivamente, y así con el umbral que se desee probar.
