...
random.seed(277327482342834723)
...
for z in range(100):
    for i in datos_entrada:
        grado_pertenencia2(i, circunferencias)

# 2.2. actualizar centros y radios
    actualizar_cluster2(circunferencias, datos_entrada)

# 3. Asignar cada punto únicamente a su cluster de mayor grado de pertenencia,
asignar_puntos2(circunferencias, datos_entrada)
...
for c in circunferencias:
    ...
    circle = plt.Circle([c.get_centro().get_x(), c.get_centro().get_y()], radius=c.get_radio(), facecolor='none', edgecolor=numpy.random.rand(3,))
...
print(tres_puntos[1])
print(tres_puntos[2])
print(tres_puntos2[0])
print(tres_puntos2[1])
print(tres_puntos2[2])
